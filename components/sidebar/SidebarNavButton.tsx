...
export const SidebarNavButton = ({
  ...
  const selected = (item.href === selectedChannelLevel?.href || item.href === selectedGroupLevel?.href )
  ...
  <Accordion.Header>
    ...
    {item.canCreate > 0 && 
    <PlusIcon 
    className='text-gray-400 hover:text-gray-100 ml-3 h-5 w-5 flex-shrink-0'
    />}
