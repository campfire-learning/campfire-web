...
import { SkinnyColumnSection } from './SkinnyColumnSection';
...
export type  SkinnyColumnContentType = SkinnyColumnContentHref | SkinnyColumnContentModal
...
export const SkinnyColumnContent = () => {
  ...
  const contentMain: SkinnyColumnContentType[] = [
    ...
    },
    {
      ...
      icon: TrophyIcon,
      modal: () => <PrimaryContentModal
        buttonInfo={{name: 'Clubs', icon: TrophyIcon}}/>,
    },
    {
      name: 'Interests',
      icon: UserGroupIcon,
