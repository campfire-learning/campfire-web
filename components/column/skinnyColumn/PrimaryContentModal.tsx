...
import { SkinnyColumnContentBase } from "./SkinnyColumnContent"
    ...
    {buttonInfo && <button 
      ...
      >
        <buttonInfo.icon
          ...
          aria-hidden="true"
        />
        <span className="mt-2 text-xs font-medium text-gray-300 group-hover:text-white">{buttonInfo.name}</span>
      </button>}
